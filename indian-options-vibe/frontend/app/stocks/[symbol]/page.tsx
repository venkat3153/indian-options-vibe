...
type RetestStatus = { status: 'success' | 'failed' | 'waiting' | 'unknown'; result: string; retest_held: boolean; source: string; message: string; retest_low?: number; retest_high?: number };
  ...
  async function addToWatchlist() {
    ...
    try {
      ...
      const payload = {
        ...
        notes: `Stock detail research page. Buyer zone: ${getBuyerZone(stock, quote)}. Seller zone: ${getSellerZone(stock, quote)}. Final: ${finalDecision.label}.`,
